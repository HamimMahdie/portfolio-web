            ...
            <div className="container mx-auto mb-20 px-20">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 items-center mb-4">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 384 512"
                                 className="w-8 h-8 fill-white cursor-pointer hover:scale-110"
                                 style={{fill: "white"}}>
                                <path
                        ...
                        <p>Code Snippets is a website that provides a way of organising all your code snippets for
                            various programming languages. The website is hosted on Netlify and has a Supabase
                            backend.</p> <br/>
                        <p>The website has a simple and user-friendly interface that allows users to add and browse
                            through the snippets and copy them to their clipboard. The snippets are organized by
                ...
                <div className="flex flex-col lg:flex-row lg:flex-row-reverse gap-12 items-center mb-20">
                    ...
                    <div>
                        ...
                        <p> Todo-List app is a JavaScript application that helps users organize their to-do lists. The
                            app allows users to create, filter, mark as complete, and delete todos. The user interface
                            is built using HTML and CSS. The app is hosted on GitHub Pages.</p> <br/>
                        <p>The app is designed to be easy to use and customizable. Users can add new todos by typing in
                            the input field and pressing the enter key. The app also allows users to filter todos by
                            their status (completed or not completed) and to delete todos by clicking on the delete
