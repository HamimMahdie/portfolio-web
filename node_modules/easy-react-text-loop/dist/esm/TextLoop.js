...
const TextLoop = ({ children, timeout = 2500, animation = "spring" }) => {
    ...
    return (React.createElement(AnimatePresence, null,
        React.createElement(motion.span, { style: { position: "absolute", marginLeft: "0.5rem", marginRight: "0.5rem" }, variants: variants, key: index, initial: "enter", animate: "center", exit: "exit", transition: {
